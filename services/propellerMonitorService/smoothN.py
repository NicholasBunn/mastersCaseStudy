...
# This was copied from https://github.com/barentsen/dave/blob/master/trapezoidFit/smoothn.py so that a local copy is made available and I don't have to play around with Pip errors. All credit to writing this script in Python goes to dave/Christopher J Burke
