...
_POWERESTIMATERESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='power_estimate_average', full_name='powerTrainService.v1.PowerEstimateResponse.power_estimate_average', index=2,
...
_COSTESTIMATERESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='power_estimate_average', full_name='powerTrainService.v1.CostEstimateResponse.power_estimate_average', index=4,
