...
class PowerTrainIntegrationTest(unittest.TestCase):
	...
	def test_CalculateRMS(self):
		...
		print("Testing Process Vibration Service: Integration Test: Calculate RMS (Service Call Test)")
		...
		with processVibrationService.grpc.insecure_channel(self.port) as channel:
			...
			response = stub.CalculateRMS(processVibrationService.process_vibration_service_api_v1_pb2.ProcessRequest(
